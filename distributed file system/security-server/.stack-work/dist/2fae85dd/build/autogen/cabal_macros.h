...
/* package security-server-0.1.0.0 */
#define VERSION_security_server "0.1.0.0"
#define MIN_VERSION_security_server(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package crypto-simple-0.1.0.0 */
#define VERSION_crypto_simple "0.1.0.0"
#define MIN_VERSION_crypto_simple(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
...
/* package distributed-api-0.1.0.0 */
#define VERSION_distributed_api "0.1.0.0"
#define MIN_VERSION_distributed_api(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
...
#define CURRENT_COMPONENT_ID "security-server-0.1.0.0-6xrqt9962SHSZspL10yzh"

#define CURRENT_PACKAGE_KEY "security-server-0.1.0.0-6xrqt9962SHSZspL10yzh"
